<div class="block">
    ...
    <table class="table sheet">
        ...
        <tr class="tr-template">
            ...
            <td><a class="content list-source">点击下载</a></td>
...
<script>
    ...
    $(document).ready(function () {
        ...
        TableController.init('purchase_list', backDataHandle);
    ...
    function registEvent() {
        $(document).on('click', '.button', function () {
            ...
            switch (type) {
                ...
                case 'delete':
                    if(confirm('确认要删除？')){
                        deleteRecord('purchase',{purchase_id:id},function(back){
                            showToast('删除成功');
                            TableController.getList();
                        });
                    }
        ...
        $(document).on('change','.status-select',function(){
            ...
            altTable('purchase','status',value,'purchase_id',id,function(){
                showToast('修改成功')
            })
        });
    ...
    function backDataHandle(back) {
        ...
        $.each(back.list, function (k, v) {
            ...
            element.find('.quote').attr('id', 'quo' + v.purchase_id);
            element.find('.delete').attr('id','del'+ v.purchase_id);
            element.find('.detail').attr('id', 'det' + v.purchase_id);
            element.find('.status-select').attr('id','stu'+ v.purchase_id);
