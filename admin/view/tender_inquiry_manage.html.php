<?php global $biddingInquiryId?>
<script>
    var biddingInquiryId = <?=$biddingInquiryId?>;
</script>
<div class="block">
    <div class="head">
        投标管理
...
<script>
    ...
    $(document).ready(function () {
        ...
        TableController.init('tender_inquiry_list', backDataHandle);
        if(biddingInquiryId)TableController.setfilter({bidding_inquiry:biddingInquiryId});
